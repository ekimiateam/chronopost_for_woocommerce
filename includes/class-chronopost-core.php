...
class Chronopost
{
    ...
    private function load_dependencies()
    {
        ...
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/products/chronotoshopdirect.php';
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/products/chronotoshopeurope.php';
        ...
        require_once plugin_dir_path(dirname(__FILE__)) . 'admin/class-chronopost-admin-notices.php';
        require_once plugin_dir_path(dirname(__FILE__)) . 'admin/class-chronopost-admin-settings.php';
        require_once plugin_dir_path(dirname(__FILE__)) . 'admin/class-chronopost-admin-upgrades.php';
    ...
    private function define_admin_hooks()
    {
        ...
        $this->loader->add_filter('admin_init', $plugin_admin, 'update_db_check');
        $this->loader->add_action('woocommerce_shipping_zone_method_added', $plugin_admin, 'shipping_zone_method_added', 10, 3);

		$plugin_admin_notices = new Chronopost_Admin_Notices($this->get_plugin_name(), $this->get_version());
		$this->loader->add_action('admin_notices', $plugin_admin_notices, 'admin_notices');
    }
